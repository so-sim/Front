...
const MobileToolbarCheckbox = React.forwardRef<HTMLInputElement, { disabled: boolean; onClick: (event: React.MouseEvent<HTMLInputElement>) => void }>(
...
export default MobileToolbarCheckbox;
